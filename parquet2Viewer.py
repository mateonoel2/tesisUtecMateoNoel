...
from pyspark.sql.functions import col, when, from_unixtime, round
...
if __name__ == '__main__':    
       ...
       min_max_dict = {'total_distance': (100, 17090), 'distance': (100, 27100), 'exit_time': (0, 86400), 'label': (0, 86400)}
